...
En ouvrant RStudio, vous verrez une fenêtre comme celle ci-dessous : 

![](img/rstudio_01.png){width="100%"}

<br>

Cette fenêtre peut être séparées en trois panneaux : 

- **La console** : vous pouvez y taper du code et l'exécuter en appuyant sur `Entrée`. Lors du lancement d'une session RStudio, elle affiche également des informations comme la version de R présente sur votre ordinateur et des indications sur la manière d'obtenir de l'aide.
