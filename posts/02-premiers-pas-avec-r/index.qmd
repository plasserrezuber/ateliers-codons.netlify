...
RStudio est une **interface graphique** s'appuyant sur le langage R.
...
Vous pouvez afficher le tableau en cliquant sur l'icône à droite du nom de l'objet dans l'environnement, ce qui ouvre un nouvel onglet à côté de votre script :
