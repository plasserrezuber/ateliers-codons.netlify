...
### La [console](https://ateliers-codons.netlify.app/glossary.html#script)
...
Vous y trouverez votre [**environnement**](https://ateliers-codons.netlify.app/glossary.html#environnement) (données importées, objets créés, fonctions définies, ...), ainsi que d'autres onglets comme l'historique des commandes exécutées ou l'accès à des tutoriels (pour les versions récentes de RStudio).
