...
- le chemin vers le fichier à importer, **entre guillemets** :  
  - chemin vers l'emplacement du fichier si vous l'avez téléchargé (`"raw/pingouins.csv"`)  
  - ou lien vers le fichier en ligne (`"https://raw.githubusercontent.com/codons-blog/C-01-PremiersPas/main/pingouins.csv"`)

```{r, echo=TRUE, eval=TRUE}
read.csv("https://raw.githubusercontent.com/codons-blog/C-01-PremiersPas/main/pingouins.csv")
```



Sauvegardez votre script (et pensez à le faire régulièrement !) en cliquant sur l'icône disquette en haut de votre script :
