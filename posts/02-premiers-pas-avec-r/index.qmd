...
- Utiliser un script  
- Importer des données, les manipuler et les représenter
...
Les fonctions suivantes permettent l'exploration rapide de l'ensemble du jeu de données :
