...
Le Tidyverse est un ensemble de packages proposant de multiples fonctions utiles à l'ensemble des étapes d'une analyse : importer les données, les manipuler, les transformer, les représenter et les exporter.

![Allison Horst](img/tidyverse_celestial.png){width="50%"}  

Voici le détail des packages faisant partie du Tidyverse : 

|     |     |     |
| :-: | :-- | :-- |
| ![](img/hex_readr.png){width="15%"} | [readr](https://readr.tidyverse.org/) | importer et exporter les données |
...
<br> Avant d'aller plus loin, nous allons voir une fonctionnalité extrêmement pratique : **le "pipe"**. Un pipe permet d'enchaîner les opérations, et présente plusieurs avantages, notamment de rendre le **code plus clair et lisible** et de rendre possible l'**auto-complétion** (à l'aide de la touche `Tab`).
