...
```{r group, eval=FALSE}
summarise(group_by(pingouins_tmp, espece),
          longueur_bec_mm_moy = mean(longueur_bec_mm, na.rm = TRUE))
```
...
summarise(group_by(pingouins_tmp, ile, espece),
          longueur_bec_mm_moy = mean(longueur_bec_mm, na.rm = TRUE))
```
