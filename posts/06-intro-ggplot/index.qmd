...
```{r basic plot 15, eval=FALSE}
ggplot(data = pingouins,
       aes(x = masse_corporelle_g)) +
  geom_histogram(col = "white", bins = 20)
```

L'argument `bin_width` permet de modifier la largeur de chaque classe sur l'axe x.