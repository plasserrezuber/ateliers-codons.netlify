...
Il est important d'associer un niveau (un nom d'espèce) à chaque couleur. Cela évitera que les couleurs soient appliquées à différentes espèces selon les manipulations de données faites avant de générer le graphique.