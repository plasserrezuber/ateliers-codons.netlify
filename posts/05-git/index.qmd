...
Créons un fichier texte basique en cliquant sur *File > New File > Text File*. Sauvegardons ce fichier à la racine de notre répertoire de travail en le nommant `.gitignore`.
Ajoutons une ligne à ce fichier comme ci-dessous : 
...
Pour afficher les différentes branches, utilisons la commande `git branch` : 
![](img/git_cmd_11.png).
