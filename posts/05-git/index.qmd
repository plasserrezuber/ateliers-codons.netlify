...
|                                           |                  |
| ----------------------------------------- | ---------------- |
| ![](img/status_new.png){width="25%"}      | nouveau fichier  |
| ![](img/status_added.png){width="25%"}    | fichier ajouté   |
| ![](img/status_modified.png){width="25%"} | fichier modifié  |
| ![](img/status_deleted.png){width="25%"}  | fichier supprimé |
