...
Ces options s'avèrent utiles si vous souhaitez afficher du code mais ne pas l'exécuter, ou si l'exécution de votre code risque de générer de longs messages d'erreur.
:::
